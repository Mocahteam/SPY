...
public class FunctionalityInLevel : MonoBehaviour {
	...
	// Dictionaire avec les fonctionnalités en clef et un tableau de boolean correspondant aux niveaux ou la fonctionnalité peux être utilisée (true) ou non (false)
	public Dictionary<string, List<string>> levelByFuncLevelDesign = new Dictionary<string, List<string>>();
	// Note quel niveau utilisé pour une compétence précise autre qu'une fonctionnalité de level design
